...
- `config/ai-approvals.json`: record which AI tools your organisation has approved (see [AI-APPROVALS.md](AI-APPROVALS.md)). Without it, every AI tool found is reported as not reviewed by SC-14, which counts towards NCSC only, never Cyber Essentials.
